...
const handlers = {
  ...
  'RecipeIntent': function () {
    ...
    this.response.speak(`Would you like to try ${recipe.label}? It requires ${ingredients}. For more information on this recipe and other checkout the Chef Alexa webapp on your phone.`)
